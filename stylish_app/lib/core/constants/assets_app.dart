...
class $AssetsIcons {
  ...
  /// File path: assets/icons/float_cart.svg
  SvgGenImage get floatCart => const SvgGenImage('assets/icons/float_cart.svg');
  ...
  SvgGenImage get onboarding1 =>
      const SvgGenImage('assets/icons/onboarding_1.svg');

  /// File path: assets/icons/onboarding_2.svg
  SvgGenImage get onboarding2 =>
      const SvgGenImage('assets/icons/onboarding_2.svg');

  /// File path: assets/icons/onboarding_3.svg
  SvgGenImage get onboarding3 =>
      const SvgGenImage('assets/icons/onboarding_3.svg');
